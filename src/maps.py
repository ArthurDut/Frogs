...
class MapManager:
    def __init__(self, screen, player):
        ...
        self.register_map("Bourg_Jaajette", portals=[
            ...
            NPC("villager", nb_points=4),
            NPC("boy", nb_points=2),
            NPC("old_woman", nb_points=1)
        ])
        self.register_map("Routin", portals=[
            ...
            NPC("Krillin", nb_points=2),
            NPC("monk_1", nb_points=1)
        ])
